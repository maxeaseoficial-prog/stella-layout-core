                  ...
                  <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-100 dark:border-blue-900/30 p-4 rounded-xl space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <Button variant="outline" size="sm" className="bg-surface gap-2" asChild>
                        <a href={`${SPEDY_BASE_URLS[notaSucesso.ambiente as any]}/product-invoices/${notaSucesso.spedyId}/pdf`} target="_blank" rel="noopener noreferrer">
                          <ExternalLink className="h-4 w-4" /> Visualizar DANFE
                        </a>
                      </Button>
                      <Button variant="outline" size="sm" className="bg-surface gap-2" asChild>
                        <a href={`${SPEDY_BASE_URLS[notaSucesso.ambiente as any]}/product-invoices/${notaSucesso.spedyId}/pdf`} download={`DANFE-${notaSucesso.numero}.pdf`}>
                          <Download className="h-4 w-4" /> Baixar PDF
                        </a>
                      </Button>
                      <Button variant="outline" size="sm" className="bg-surface gap-2 col-span-2" asChild>
                        <a href={`${SPEDY_BASE_URLS[notaSucesso.ambiente as any]}/product-invoices/${notaSucesso.spedyId}/xml`} download={`NFe-${notaSucesso.numero}.xml`}>
